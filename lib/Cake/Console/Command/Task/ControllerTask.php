 ...
 */
	public function bakeActions($controllerName, $admin = null, $wannaUseSession = true) {
        ...
        $ucPluralName=ucfirst($pluralName);
		$singularName = Inflector::variable($currentModelName);
        $ucSingularName=ucfirst($singularName);
		...
		$this->Template->set(compact(
			...
			'singularHumanName', 'ucPluralName', 'ucSingularName', 'pluralHumanName', 'modelObj', 'wannaUseSession', 'currentModelName',
			'displayField', 'primaryKey', 'fields', 'fields_flip'
		));
